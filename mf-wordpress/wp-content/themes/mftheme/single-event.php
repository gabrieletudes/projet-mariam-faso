...
<div class="section-wrapper">
    <div class="section article-section">
        <article class="article-section__article">
            <h2 class="article-section__title"><?php the_field('event_title');?></h2>
            <div class="article-section__labels-wrapper">
                <span class="article-section__label"><?= __('Du','mf');?></span>
                <time class="article-section__time" datetime="2017-11-03"><?php the_field('event_start');?></time><span>au</span><time class="article-section__time" datetime="2017-11-03"><?php the_field('event_ended');?></time>
            </div>
            <div class="article-section__labels-wrapper">
                <span class="article-section__label"><?= __('Lieu','mf')?></span>
                <p class="article-section__place"><?= get_field('event_adress') ? get_field('event_adress') : __('pas d’adresse indique','mf');?></p>
            </div>
            <span class="tag tag--green"><?= __('événement','mf');?></span>
            ...
            <div class="button-wrapper button-wrapper--top button-wrapper--on-inversed">
                <?php if (get_field('event_link')): ?>
                    ...
                    <a href="<?php the_field('event_link');?>" class="cta-button cta-button--mr"><?= __('Indiquer ma participation via Facebook','mf');?></a>
                <?php else:?>
                    <a href="<?= mf_get_page_url('contact.php')?>" class="cta-button cta-button--mr-32"><?= __('Contactez-nous','mf');?></a>
                <?php endif; ?>
            </div>
    ...
    <div class="section-wrapper">
        <section class="section photos-section">
            <header class="section__header">
                <h2 class="section__title"><?= __('Des photos de cet événement','mf')?></h2>
            </header>
        ...
        <div class="button-wrapper button-wrapper--top button-wrapper--on-inversed">
            <a href="<?= get_page_url('donation?php')?>" class="cta-button cta-button--on-inversed"><?=__('Soutenez nos projets','mf')?></a>
